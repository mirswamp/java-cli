...
1. Go to SiB from the webbrowser and download the SiB self-signed certificate by following these instruction here:
...
Example for the output of the above command:
```
Name                  UUID                                   Supported Package Types                  Supported Platforms
JSHint                39001e1f-b741-11e6-bf70-001a4a81450b   ["Web Scripting"]                        [scientific-6-32, ubuntu-14.04-64, scientific-5.11-32, centos-5-32, ubuntu-16.04-64]
HTML Tidy             44ec433d-b741-11e6-bf70-001a4a81450b   ["Web Scripting"]                        [scientific-6-32, ubuntu-14.04-64, scientific-5.11-32, centos-5-32, ubuntu-16.04-64]
Parasoft C/C++test    4bb2644d-6440-11e4-a282-001a4a81450b   ["C/C++"]                                [scientific-6-32, ubuntu-14.04-64, scientific-5.11-32, centos-5-32, ubuntu-16.04-64]
...
Example:
```
java -jar java-cli-1.3.jar package -T
```
